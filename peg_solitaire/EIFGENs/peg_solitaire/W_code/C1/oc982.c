...
extern void F982_7293(EIF_REFERENCE);
extern EIF_TYPED_VALUE F982_7294(EIF_REFERENCE);
...
/* {OCCUPIED_SLOT}.make */
void F982_7293 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13558);
	RTSA(Dtype(Current));
	RTSC;
...
/* {OCCUPIED_SLOT}.out */
EIF_TYPED_VALUE F982_7294 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13559);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13559);
	RTIV(Current, RTAL);
	RTHOOK(1);
