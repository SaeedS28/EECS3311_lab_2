...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 0, 2, 13802);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1017, Current, 13802);
	RTIV(Current, RTAL);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1017, Current, 0, 1, 13804);
	RTSA(Dtype(Current));
	RTSC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 0, 2, 13805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 0, 3, 13808);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 0, 3, 13809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1018_3841 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1017, Current, 0, 0, 13810);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 0, 2, 13811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 3, 3, 13812);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
