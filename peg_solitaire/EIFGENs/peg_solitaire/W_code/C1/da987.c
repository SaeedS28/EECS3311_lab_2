...
extern EIF_TYPED_VALUE F987_7384(EIF_REFERENCE);
extern EIF_TYPED_VALUE F987_7385(EIF_REFERENCE);
extern EIF_TYPED_VALUE F987_7386(EIF_REFERENCE);
...
EIF_TYPED_VALUE F987_7384 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F987_7385 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F987_7386 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 13641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 13641);
	RTIV(Current, RTAL);
	RTHOOK(1);
