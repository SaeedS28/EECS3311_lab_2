...
extern EIF_TYPED_VALUE F990_7382(EIF_REFERENCE);
extern EIF_TYPED_VALUE F990_7383(EIF_REFERENCE);
extern EIF_TYPED_VALUE F990_7384(EIF_REFERENCE);
...
EIF_TYPED_VALUE F990_7382 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F990_7383 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F990_7384 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5151, "fractional_second", tr1));
