...
void F979_7295 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A979_77, (EIF_POINTER)(0),5111, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 978, Current, 1, 0, 13561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
