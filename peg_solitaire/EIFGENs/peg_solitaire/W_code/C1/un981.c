...
extern void F981_7291(EIF_REFERENCE);
extern EIF_TYPED_VALUE F981_7292(EIF_REFERENCE);
...
void F981_7291 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13556);
	RTSA(Dtype(Current));
	RTSC;
...
/* {UNOCCUPIED_SLOT}.out */
EIF_TYPED_VALUE F981_7292 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13557);
	RTIV(Current, RTAL);
	RTHOOK(1);
