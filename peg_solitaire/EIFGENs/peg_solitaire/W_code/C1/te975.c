...
extern void F975_7282(EIF_REFERENCE);
...
void F975_7282 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 974, Current, 0, 0, 13547);
	RTSA(Dtype(Current));
	RTSC;
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A975_77, (EIF_POINTER)(0),5098, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 974, Current, 1, 0, 13548);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5199, "wins_easy_board", loc1))(loc1);
	RTHOOK(5);
