...
extern EIF_TYPED_VALUE F966_7155(EIF_REFERENCE);
extern EIF_TYPED_VALUE F966_7156(EIF_REFERENCE);
extern EIF_TYPED_VALUE F966_7157(EIF_REFERENCE);
extern EIF_TYPED_VALUE F966_7158(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F966_7153,13428,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13428);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(965, Current, 13428);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F966_7155)
EIF_TYPED_VALUE F966_7155 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13429);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(965, Current, 13429);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F7, 0,0); /* Result */
...
RTOID (F966_7156)
EIF_TYPED_VALUE F966_7156 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13430);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(965, Current, 13430);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F7, 0,0); /* Result */
...
RTOID (F966_7157)
EIF_TYPED_VALUE F966_7157 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 965, Current, 0, 0, 13431);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(965, Current, 13431);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F7, 0,0); /* Result */
...
EIF_TYPED_VALUE F966_7158 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F966_7158,13433,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F966_7159,13434,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F966_7160,13435,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
...
void EIF_Minit966 (void)
{
	...
	RTOTS (7154,F966_7154)
	RTOTS (7155,F966_7155)
	RTOTS (7156,F966_7156)
	RTOTS (7157,F966_7157)
	RTOTS (7158,F966_7158)
	RTOTS (7159,F966_7159)
	RTOTS (7160,F966_7160)
}
