...
extern EIF_TYPED_VALUE F988_7393(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F988_7393 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 987, Current, 0, 1, 13641);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
