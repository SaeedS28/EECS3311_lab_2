/*
 * Code for class BAD_PLAYER_TESTS
 */
...
extern void F977_7288(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_7289(EIF_REFERENCE);
...
/* {BAD_PLAYER_TESTS}.bta */
EIF_TYPED_VALUE F977_7287 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = (Current + RTWA(5102,Dtype(Current)));
	return r;
}


/* {BAD_PLAYER_TESTS}.make */
void F977_7288 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 976, Current, 0, 0, 13553);
	RTSA(Dtype(Current));
	RTSC;
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A977_78, (EIF_POINTER)(0),5104, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F977_7289 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "test_loss_pyramid_board";
	RTEX;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 976, Current, 1, 0, 13554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = RTMS_EX_H("test:plus board won and over",28,1153284722);
	ur1 = tr1;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(4987, Dtype(tr1)))(tr1);
	RTNHOOK(2,1);
	...
	RTNHOOK(3,2);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4947, "pyramid_board", tr3))(tr3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	if (RTEQ(tr1, tr2)) {
