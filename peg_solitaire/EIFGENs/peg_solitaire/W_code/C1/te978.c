...
extern void F978_7293(EIF_REFERENCE);
extern EIF_TYPED_VALUE F978_7294(EIF_REFERENCE);
...
void F978_7293 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13558);
	RTSA(Dtype(Current));
	RTSC;
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A978_77, (EIF_POINTER)(0),5108, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F978_7294 (EIF_REFERENCE Current)
{
	GTCX
